    ...
    static let littleFamily = SUSUGroup(
        ...
        members: [
            GroupMember(id: UUID(), name: "Dante (You)", initials: "DL", role: .owner, walletBalance: 142.80, colorHex: "#1B6CA8",
                ...
                bio: "Founder of the Harbor Circle Fund. Building for the future together.",
                monthlyContributions: [90, 110, 105, 120, 95, 100], badges: ["🏆", "⚡️", "💎"]),
            GroupMember(id: UUID(), name: "Aunt Nia", initials: "AN", role: .trustee, walletBalance: 218.40, colorHex: "#2D6A4F",
            ...
            GroupMember(id: UUID(), name: "Coach Eli", initials: "CE", role: .trustee, walletBalance: 190.00, colorHex: "#C84B31",
            ...
            GroupMember(id: UUID(), name: "Maya", initials: "MY", role: .member, walletBalance: 87.20, colorHex: "#4A2FBD",
            ...
            GroupMember(id: UUID(), name: "Noah", initials: "NH", role: .member, walletBalance: 55.60, colorHex: "#BE185D",
        ...
        proposals: [
            Proposal(
                ...
                votes: [
                    Vote(id: UUID(), memberName: "Aunt Nia", choice: .approve),
                    Vote(id: UUID(), memberName: "Coach Eli", choice: .approve),
                ],
                status: .pending,
            ...
            Proposal(
                ...
                votes: [
                    ...
                    Vote(id: UUID(), memberName: "Coach Eli", choice: .approve),
                    Vote(id: UUID(), memberName: "Noah", choice: .approve),
                ],
                status: .approved,
        ...
        transactions: [
            ...
            GroupTransaction(id: UUID(), description: "Round-up from Uber", amount: 0.45, type: .roundUp, date: Calendar.current.date(byAdding: .hour, value: -8, to: Date())!, memberName: "Aunt Nia"),
            GroupTransaction(id: UUID(), description: "Monthly contribution", amount: 50, type: .contribution, date: Calendar.current.date(byAdding: .day, value: -1, to: Date())!, memberName: "Coach Eli"),
            ...
            GroupTransaction(id: UUID(), description: "Round-up from Target", amount: 1.30, type: .roundUp, date: Calendar.current.date(byAdding: .day, value: -2, to: Date())!, memberName: "Noah"),
        ],
    ...
    static let friendGroup = SUSUGroup(
        ...
        members: [
            GroupMember(id: UUID(), name: "Dante (You)", initials: "DL", role: .owner, walletBalance: 62.10, colorHex: "#1B6CA8",
                ...
                bio: "Started Studio Collective to fund our (legendary) summer trip.",
                monthlyContributions: [60, 70, 80, 65, 55, 50], badges: ["🏆", "✈️"]),
            GroupMember(id: UUID(), name: "Jordan", initials: "JD", role: .trustee, walletBalance: 75.00, colorHex: "#2D6A4F",
            ...
            GroupMember(id: UUID(), name: "Ava", initials: "AV", role: .member, walletBalance: 50.30, colorHex: "#C84B31",
                totalContributed: 210, joinedDate: Calendar.current.date(byAdding: .month, value: -2, to: Date())!,
                bio: "Counting down the days till Vegas!",
                monthlyContributions: [35, 40, 45, 50, 40, 0], badges: ["🌟", "🎉"]),
            GroupMember(id: UUID(), name: "Kai", initials: "KI", role: .member, walletBalance: 38.90, colorHex: "#4A2FBD",
        ...
        transactions: [
            ...
            GroupTransaction(id: UUID(), description: "Monthly contribution", amount: 25, type: .contribution, date: Calendar.current.date(byAdding: .day, value: -3, to: Date())!, memberName: "Jordan"),
        ],
...
extension SUSUGroup {
    ...
    static let littleFamilyBoard: [BoardPost] = {
        ...
        // Poll 1 — Aunt Nia asks about birthday weekend
        let poll1Options = [
            PollOption(id: UUID(), text: "Weekend of June 7th", votes: ["Aunt Nia", "Maya", "Noah"]),
            PollOption(id: UUID(), text: "Weekend of June 14th", votes: ["Dante (You)", "Coach Eli"]),
        ...
        let poll1 = BoardPost(
            ...
            likes: ["Coach Eli", "Maya", "Noah"],
            comments: [
                BoardComment(id: UUID(), author: "Coach Eli", authorColorHex: "#C84B31", authorInitials: "CE",
                ...
                BoardComment(id: UUID(), author: "Maya", authorColorHex: "#4A2FBD", authorInitials: "MY",
        ...
        // Post 1 — Coach Eli celebrating contribution
        let post1 = BoardPost(
            id: UUID(),
            author: "Coach Eli",
            ...
            likes: ["Aunt Nia", "Dante (You)", "Maya", "Noah"],
            comments: [
                BoardComment(id: UUID(), author: "Aunt Nia", authorColorHex: "#2D6A4F", authorInitials: "AN",
        ...
        let poll2Options = [
            PollOption(id: UUID(), text: "Yes — open it for true emergencies only", votes: ["Aunt Nia", "Coach Eli"]),
            PollOption(id: UUID(), text: "No — let it keep growing for now", votes: ["Maya"]),
            PollOption(id: UUID(), text: "Set a clear rule before we decide", votes: ["Noah"]),
        ]
        let poll2 = BoardPost(
            id: UUID(),
            author: "Dante (You)",
            ...
            likes: ["Aunt Nia", "Coach Eli"],
            comments: [
                BoardComment(id: UUID(), author: "Noah", authorColorHex: "#BE185D", authorInitials: "NH",
        ...
        let post2 = BoardPost(
            ...
            likes: ["Aunt Nia", "Coach Eli", "Dante (You)", "Maya"],
            comments: [
                BoardComment(id: UUID(), author: "Maya", authorColorHex: "#4A2FBD", authorInitials: "MY",
                             text: "Noah! 😭 This made my morning. We got you too.",
                             timestamp: d.date(byAdding: .day, value: -5, to: Date())!),
            ],
            pollOptions: [],
            pinnedEmoji: nil
    ...
    static let friendGroupBoard: [BoardPost] = {
        ...
        // Post 1 — Jordan hypes up Aria availability
        let post1 = BoardPost(
            id: UUID(),
            author: "Jordan",
            authorColorHex: "#2D6A4F",
            ...
            likes: ["Dante (You)", "Ava", "Kai"],
            comments: [
                BoardComment(id: UUID(), author: "Ava", authorColorHex: "#C84B31", authorInitials: "AV",
                             text: "YESSSS 🙌 I've been ready. Let's vote on the proposal and lock it down!",
                             timestamp: d.date(byAdding: .hour, value: -3, to: Date())!),
                BoardComment(id: UUID(), author: "Kai", authorColorHex: "#4A2FBD", authorInitials: "KI",
        ...
        // Poll — Ava asks about monthly savings target
        let pollOptions = [
            PollOption(id: UUID(), text: "$50 / month", votes: ["Kai"]),
            PollOption(id: UUID(), text: "$75 / month", votes: ["Ava", "Jordan"]),
        ...
        let poll = BoardPost(
            ...
            comments: [
                BoardComment(id: UUID(), author: "Kai", authorColorHex: "#4A2FBD", authorInitials: "KI",
                             ...
                             timestamp: d.date(byAdding: .day, value: -2, to: Date())!),
                BoardComment(id: UUID(), author: "Jordan", authorColorHex: "#2D6A4F", authorInitials: "JD",
